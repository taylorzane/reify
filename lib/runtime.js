...
exports.enable = function (Module) {
  ...
  // Method for determining if the current module is an ES module (if
  // called with no arguments) or if the given argument appears to be an
  // exports object of an ES module (if called with an argument).
  Mp.isESModule = function (exports) {
    return getESModule(exports || this.exports);
  };
